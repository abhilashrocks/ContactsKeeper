...
const ContactForm = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
            ...
            <input type="radio" onChange={onChange} name='type' value='personal' checked={type === 'personal'} />
            Personal{' '}
            <input type="radio" onChange={onChange} name='type' value='professional' checked={type === 'professional'} />
            Professional{' '}
            <div>
